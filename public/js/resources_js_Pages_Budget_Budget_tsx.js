(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_Pages_Budget_Budget_tsx"],{
...
var Navigation_1 = __importDefault(__webpack_require__(/*! ./Navigation */ "./resources/js/Layouts/Navigation.tsx"));

var SideNavigation_1 = __importDefault(__webpack_require__(/*! ./SideNavigation */ "./resources/js/Layouts/SideNavigation.tsx"));

var inertia_react_1 = __webpack_require__(/*! @inertiajs/inertia-react */ "./node_modules/@inertiajs/inertia-react/dist/index.js");

var MainLayout = function MainLayout(_a) {
  var children = _a.children,
      budget = _a.budget,
      accounts = _a.accounts;
  var user = (0, inertia_react_1.usePage)().props.user;
  return react_1["default"].createElement(react_1["default"].Fragment, null, react_1["default"].createElement(Navigation_1["default"], null), react_1["default"].createElement("div", {
    className: "w-full flex flex-col sm:flex-row flex-grow overflow-hidden"
  }, user && budget && accounts && react_1["default"].createElement(SideNavigation_1["default"], {
    budget: budget,
    accounts: accounts
...
var Navigation = function Navigation() {
  var user = (0, inertia_react_1.usePage)().props.user;
  return react_1["default"].createElement("nav", null, react_1["default"].createElement("div", {
    className: "container mx-auto px-6 py-2 flex justify-between items-center"
  }, react_1["default"].createElement("a", {
    className: "font-bold text-2xl lg:text-4xl",
    href: "/"
  }, "Budget"), react_1["default"].createElement("div", {
    ...
    href: "/"
  }, "Home")), user ? react_1["default"].createElement(react_1["default"].Fragment, null, react_1["default"].createElement("li", null, react_1["default"].createElement(inertia_react_1.Link, {
    method: 'post',
    as: 'button',
    href: "/logout"
  }, "Logout"))) : react_1["default"].createElement(react_1["default"].Fragment, null, react_1["default"].createElement("li", null, react_1["default"].createElement(inertia_react_1.Link, {
    as: 'button',
    className: "px-4 hover:text-gray-800",
    href: "/login"
  }, "Login")), react_1["default"].createElement("li", null, react_1["default"].createElement("a", {
    className: "px-4 hover:text-gray-800",
    href: "/register"
  }, "Register")))))));
};
...
/***/ "./resources/js/Layouts/SideNavigation.tsx":
/*!*************************************************!*\
  !*** ./resources/js/Layouts/SideNavigation.tsx ***!
  \*************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var SideNavigation = function SideNavigation(_a) {
  var budget = _a.budget,
      accounts = _a.accounts;
  return react_1["default"].createElement("div", {
    className: " w-70 flex-shrink flex-grow-0 p-4"
  }, react_1["default"].createElement("div", {
    className: "sticky top-0 p-4 bg-gray-100 rounded-xl w-full"
  }, react_1["default"].createElement("a", {
    href: "/budget/".concat(budget.id)
  }, react_1["default"].createElement("div", {
  ...
  }, budget.budget_name))))), react_1["default"].createElement("ul", {
    ...
    return react_1["default"].createElement("li", {
      ...
      href: "/account/".concat(account.id, "/show"),
    ...
    })), react_1["default"].createElement("span", null, account.account_name, " - $", account.account_balance)));
  })), react_1["default"].createElement("div", {
    className: "text-center bottom-0 absolute w-full"
...
/***/ "./resources/js/Pages/Budget/Budget.tsx":
/*!**********************************************!*\
  !*** ./resources/js/Pages/Budget/Budget.tsx ***!
  \**********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var BudgetTable_1 = __importDefault(__webpack_require__(/*! ./BudgetTable */ "./resources/js/Pages/Budget/BudgetTable.tsx"));

var inertia_react_1 = __webpack_require__(/*! @inertiajs/inertia-react */ "./node_modules/@inertiajs/inertia-react/dist/index.js");

var Budget = function Budget(_a) {
  var budget = _a.budget,
      all_accounts = _a.all_accounts,
      account_balance = _a.account_balance;
  return react_1["default"].createElement(MainLayout_1["default"], {
    budget: budget,
    accounts: all_accounts
  }, react_1["default"].createElement("div", {
    className: "flex justify-around border-black px-6 py-2 flex"
  }, react_1["default"].createElement("div", {
    className: 'block'
  }, react_1["default"].createElement(inertia_react_1.Link, {
    ...
    href: '#',
    as: 'button'
  }, "Create Category")), react_1["default"].createElement("span", {
    className: "py-1.5 px-2.5 text-center\n                       font-bold bg-blue-600 text-white rounded"
  }, "Balance: $", account_balance)), react_1["default"].createElement("div", {
    className: 'container rounded-md border-2 border-gray-400'
  }, react_1["default"].createElement(BudgetTable_1["default"], null)));
};
...
var BudgetTable = function BudgetTable() {
  ...
  return react_1["default"].createElement(react_1["default"].Fragment, null, react_1["default"].createElement("div", {
    ...
    className: "w-full text-sm text-left text-gray-500 dark:text-gray-400 compact"
  }), react_1["default"].createElement("thead", {
    className: "text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400"
  }, // Loop over the header rows
  headerGroups.map(function (headerGroup) {
    return (// Apply the header row props
      react_1["default"].createElement("tr", __assign({}, headerGroup.getHeaderGroupProps()), // Loop over the headers in each row
      headerGroup.headers.map(function (column) {
        return (// Apply the header cell props
          react_1["default"].createElement("th", __assign({}, column.getHeaderProps()), // Render the header
  ...
  rows.map(function (row) {
    ...
    return (// Apply the row props
      react_1["default"].createElement("tr", __assign({}, row.getRowProps()), // Loop over the rows cells
      row.cells.map(function (cell) {
        // Apply the cell props
        return react_1["default"].createElement("td", __assign({}, cell.getCellProps()), // Render the cell contents
        cell.render('Cell'));
      }))
    );
  })))));
